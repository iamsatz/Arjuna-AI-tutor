...
export function LessonScreen({
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col bg-arjuna-bg px-4 pt-4 pb-24">
      {/* ── Top bar ── */}
      <header className="mb-3 flex items-center justify-between gap-2">
        <span className="text-lg font-bold text-arjuna-text tracking-tight">Arjuna</span>
        <Link
          href="/settings"
      ...
      {/* ── AI key notice — only shown when action needed, below top bar ── */}
      <GeminiStatusPill />
