  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <button
        ...
        disabled={isTv || !onTap}
        className={`relative overflow-hidden rounded-full bg-gradient-to-b from-arjuna-primaryLight to-arjuna-primaryLight shadow-chunky transition active:scale-95 ${ringClass}`}
